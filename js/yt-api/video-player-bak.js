...
$(function(){
   ...
   // inicializando o player
	...
	function verficaValorTemplate(valorTemplate){
		...
		if(template < 1.5){ template = 1; }
		if((template < 2.5) && (template > 1.5)){ template = 2; }
		if((template < 3.5) && (template > 2.5)){ template = 3; }
	...
	function slideGo(lista, classe, posicaoInicial, posicaoClick){
		if((lista != undefined) && (classe != undefined) && (posicaoInicial != undefined) && (posicaoClick != undefined)){
			
		}else{
			var template = $('.firme-lista li').width() / 276;
			...
			//console.log('valor margem: '+valorMargem);
	...
	function slideBack(lista, classe, posicaoInicial, posicaoClick){
		if((lista != undefined) && (classe != undefined) && (posicaoInicial != undefined) && (posicaoClick != undefined)){
