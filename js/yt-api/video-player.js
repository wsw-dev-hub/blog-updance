...
$(function(){
   ...
   // inicializando o player
    ...
    function onPlayerReady(event) {
		...
		$('.video-bar-range').on('click touchend', function () {
	...
	switch (event.data) {
		case YT.PlayerState.ENDED:
			...
			var $vi = $(".playerVideos.viewer").next().attr("id");
        ...
        case YT.PlayerState.PLAYING:
			...
			//console.log('Assistindo...' +largura + ' ValorTop: '+valorTop);
			break;
	...
	$('.firme-lista li').click(function(){
		...
		if(selectedAtual < novoSelected){
			...
			console.log("selectedAtual: " + selectedAtual);		
			console.log("novoSelected: " + novoSelected);
			console.log("margemInicial: " + margemInicial);
			console.log("margemAtual: " + margemAtual);
	...
	function iniciarPaginacaoDots(){
		...
		console.log("resultadoCalc: " + resultadoCalc);
	...
	function atualizarPaginacaoDots(idSelecaoAtual, clickSelecao){
		...
		if(idSelecaoAtual != clickSelecao){
			...
			if(idSelecaoAtual < clickSelecao){
				...
				for(var n = $('.firme-lista li.hiddem').length; n >= $('.firme-lista li.selected').index(); n--){
					$('.firme-lista li:eq('+n+")").removeClass('hiddem').next().addClass("no-actived").css({"transitions":"0.5s"});
					console.log('card: '+$('.firme-lista li:eq('+n+")").index());
				}
			...
			if(idSelecaoAtual > clickSelecao){
				...
				for(var x=$('.firme-lista li').length; x >= indiceCardClick; x--){
	...
	function slideGo(listName, className, posicaoSelect, posicaoClick){
		if((listName != undefined) && (className != undefined) && (posicaoSelect != undefined) && (posicaoClick != undefined)){
			...
			console.log("valorMargem: " + valorMargem);
			console.log("indiceAtual: " + indiceAtual);
			console.log("indiceTotal: " + indiceTotal);
			verificarSalto("g");
	...
	function verificarSalto(valorSalto){
		if(valorSalto == "g"){
			...
			console.log("valorCard: "+ cardAtual);
			console.log("valorDot: "+ dotAtual);
		...
		console.log("valorTemplate: " + valorTemplate);
		...
		console.log("dotTotal: " + $('.pages li').length);
		console.log("dotAtual: " + dotAtual);
