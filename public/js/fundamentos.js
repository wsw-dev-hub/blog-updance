 ...
 * ----------------------------------------------------------------
 *  Requisitos:
 *    - /js/fundamentos.data.js carregado ANTES (expõe UDX_FUNDAMENTOS)
...
(function (win, doc) {
  ...
  var CHAVE_LOCAL = 'udx:temporada:v1';
  ...
  var Regras = {
    ...
    elegivelPromocao: function () { return Regras.insigniaOk(IDX['fund-insignia']); },
  ...
  var Acoes = {
    enviar: function (desafioId) {
      ...
      fetch(API.desafio, {
        ...
        body: JSON.stringify({ desafio: desafioId })
      })
        .then(function (r) { return r.ok ? r.json() : null; })
        .then(function (j) {
